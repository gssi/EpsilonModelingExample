...
public class ConferenceSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ConferencePackage.PC_MEMBER: {
				PCMember pcMember = (PCMember)theEObject;
				T result = casePCMember(pcMember);
				if (result == null) result = casePerson(pcMember);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ConferencePackage.SPEAKER: {
				Speaker speaker = (Speaker)theEObject;
				T result = caseSpeaker(speaker);
				if (result == null) result = casePerson(speaker);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ConferencePackage.SUBMISSION: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>PC Member</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>PC Member</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T casePCMember(PCMember object) {
		return null;
	}
