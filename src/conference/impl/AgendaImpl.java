 ...
 * </p>
 * <ul>
 *   <li>{@link conference.impl.AgendaImpl#getDays <em>Days</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AgendaImpl extends MinimalEObjectImpl.Container implements Agenda {
	...
	protected EClass eStaticClass() {
		return ConferencePackage.Literals.AGENDA;
	}
	...
	public EList<Day> getDays() {
		if (days == null) {
			days = new EObjectContainmentEList<Day>(Day.class, this, ConferencePackage.AGENDA__DAYS);
		}
		return days;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ConferencePackage.AGENDA__DAYS:
